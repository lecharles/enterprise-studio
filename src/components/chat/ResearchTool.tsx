...
export function ResearchTool({
  ...
  const sources = [
    ...
    { id: 'salesforceMarketingCloud', label: 'Salesforce Marketing Cloud', icon: <img src="/lovable-uploads/7290cda8-cab3-4ac6-85dd-7ca4f7f54a49.png" alt="Salesforce Marketing Cloud" className="w-4 h-4" />, enabled: enabledSources.salesforceMarketingCloud },
